...
#
# Вам необходимо обработать ее с помощью BeautifulSoup и вывести все ссылки, которые есть на этой странице, в том
# порядке как они встречались по одной в строке.
#
